...
const PrivacyPolicyModal: React.FC<PrivacyPolicyProps> = ({ onClose }) => {
...
<div className="fixed inset-0 backdrop-blur-sm bg-white/30 flex items-center justify-center z-50">
    ...
    <h2 className="text-[20px] font-medium text-center">Add Privacy Policy</h2>
    ...
    <div className="flex flex-col gap-4">
        ...
        <div>
        <label className="block text-sm mb-1">Enter Privacy Policy</label>
